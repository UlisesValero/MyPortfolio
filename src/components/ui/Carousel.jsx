...
<AnimatePresence mode="wait">
  <motion.div
    ...
    className="w-full lg:w-1/2 px-5 pt-10 flex flex-col justify-between gap-5"
  >
    ...
    <a
      ...
      className="flex items-center justify-center bg-green-400 dark:bg-salmon w-fit p-2 rounded-full hover:bg-green-300 dark:hover:bg-salmon/80 transition"
    >
