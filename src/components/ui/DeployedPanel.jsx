                    ...
                    <ul
                        ...
                        {label.target.startsWith("http") ? (
                            <a
                                ...
                                className="font-extralight w-fit dark:bg-ddgray bg-lgray/30 text-white dark:shadow-salmon shadow-lgray dark:border-salmon border-lgray border shadow-custom py-3 px-6 rounded-2xl theme-animation ease-in-outhover:scale-105 active:scale-95 focus:outline-none focus:ring-2 focus:ring-lgray dark:focus:ring-salmon dark:hover:bg-salmon/70 hover:bg-lgray/70 hover:scale-105 cursor-pointer"
                            >
                                {label.category}
                            </a>
                        ) : (
